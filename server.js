...
// NotesChatbot — Gemini intent extraction
...
If the user is just being friendly (e.g., "tq", "thank you"), reply with:
...
Do NOT include explanations. Return ONLY clean JSON. No markdown, no triple backticks. Strictly valid JSON.
